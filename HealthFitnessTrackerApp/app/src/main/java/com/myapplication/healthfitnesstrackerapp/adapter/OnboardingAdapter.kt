...
//package com.myapplication.healthfitnesstrackerapp.adapter
...
import com.myapplication.healthfitnesstrackerapp.R

class OnboardingAdapter(private val context: Context, private val slides: List<String>) : PagerAdapter() {
